...
import { expensesPages } from './pages-expenses'
...
export const pages: PluginPage[] = [...corePages, ...lifecyclePages, ...leavePages, ...shiftsPages, ...recruitmentPages, ...performancePages, ...expensesPages, ...payPages]
